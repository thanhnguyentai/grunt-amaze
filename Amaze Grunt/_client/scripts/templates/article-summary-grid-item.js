...
return Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "        <p class=\"article-summary__date text--small\">"
  ...
  return "        <p class=\"article-summary__type text--small\">"
    + this.escapeExpression(((helper = (helper = helpers.date || (depth0 != null ? depth0.date : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0,{"name":"date","hash":{},"data":data}) : helper)))
    + "</p>\r\n";
  ...
  return "            <p class=\"article-summary__onward-icons activity-icons\">\r\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.showComments : depth0),{"name":"if","hash":{},"fn":this.program(15, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.showViews : depth0),{"name":"if","hash":{},"fn":this.program(17, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "            </p>\r\n";
  ...
  return "\r\n<article class=\"article-summary"
    ...
    + "\" \r\n    data-types=\""
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.types : depth0),{"name":"each","hash":{},"fn":this.program(5, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "\" \r\n    data-services=\""
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.services : depth0),{"name":"each","hash":{},"fn":this.program(5, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "\" \r\n    data-year=\""
    ...
    + "\">\r\n\r\n"
    + ((stack1 = (helpers.is || (depth0 && depth0.is) || alias1).call(depth0,(depth0 != null ? depth0.type : depth0),"News Article",{"name":"is","hash":{},"fn":this.program(10, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "\r\n"
    + ((stack1 = (helpers.is || (depth0 && depth0.is) || alias1).call(depth0,(depth0 != null ? depth0.type : depth0),"Case Study",{"name":"is","hash":{},"fn":this.program(12, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    ...
    + alias3(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"title","hash":{},"data":data}) : helper)))
    + "</span></a></p>\r\n\r\n"
    + ((stack1 = (helpers.and || (depth0 && depth0.and) || alias1).call(depth0,(depth0 != null ? depth0.showComments : depth0),(depth0 != null ? depth0.showViews : depth0),{"name":"and","hash":{},"fn":this.program(14, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "\r\n        </div>\r\n\r\n    </div>\r\n\r\n</article>";
},"useData":true})
